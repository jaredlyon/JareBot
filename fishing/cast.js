module.exports = {
    ...
    main: function (bot, msg) {
        if (new Date() - new Date(bot.fishing[msg.author.id].lastFish) >= 12000 && bot.bank[msg.author.id].balance >= 10) {
            ...
            if (roll <= 500) {
                ...
                bot.stats[msg.author.id].fishing.casts += 1;
                msg.channel.send(':tropical_fish: | You caught a rare fish!')
            } else if (roll == 1001) {
                bot.fishing[msg.author.id].lastFish = new Date();
                bot.bank[msg.author.id].balance -= 10;
                ...
                bot.stats[msg.author.id].fishing.casts += 1;
                msg.channel.send(':crab: | You caught a crab...without a crab trap?')
            } else if (roll == 1002) {
                bot.fishing[msg.author.id].lastFish = new Date();
                bot.bank[msg.author.id].balance -= 10;
                ...
                bot.stats[msg.author.id].fishing.casts += 1;
                msg.channel.send(':crocodile: | You caught a crocodile?! How did that even happen?')
            } else if (roll == 1003) {
                bot.fishing[msg.author.id].lastFish = new Date();
                bot.bank[msg.author.id].balance -= 10;
                ...
                bot.stats[msg.author.id].fishing.casts += 1;
                msg.channel.send(':whale2: | You caught a whale!! Is your line made of steel cable?')
            } else if (roll == 1004) {
                bot.fishing[msg.author.id].lastFish = new Date();
                bot.bank[msg.author.id].balance -= 10;
                ...
                bot.stats[msg.author.id].fishing.casts += 1;
                msg.channel.send(`:dolphin: | You caught a dolphin! Now who's more intelligent?`)
            } else if (roll == 1005) {
                bot.fishing[msg.author.id].lastFish = new Date();
                bot.bank[msg.author.id].balance -= 10;
                ...
                bot.stats[msg.author.id].fishing.casts += 1;
                msg.channel.send(`:blowfish: | You caught a blowfish!`)
            } else if (roll == 1006) {
                bot.fishing[msg.author.id].lastFish = new Date();
                bot.bank[msg.author.id].balance -= 10;
                ...
                bot.stats[msg.author.id].fishing.casts += 1;
                msg.channel.send(`:squid: | You caught a squid!`)
            } else if (roll == 1007) {
                bot.fishing[msg.author.id].lastFish = new Date();
                bot.bank[msg.author.id].balance -= 10;
                ...
                bot.stats[msg.author.id].fishing.casts += 1;
                msg.channel.send(`:shark: | You caught a shark?! You should get signed for Shark Week!`)
            }
        } else if (new Date() - new Date(bot.fishing[msg.author.id].lastFish) <= 12000) {
            msg.reply("you can only fish every **12** seconds!")
        } else if (bot.bank[msg.author.id].balance <= 10) {
            var balance = Number(bot.bank[msg.author.id].balance);
            var absbalance = Math.abs(balance);
            msg.reply(`it costs **$10** to cast! Your current balance is **$${absbalance.toFixed(2)}**!`)
        } else {
