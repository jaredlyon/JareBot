module.exports = {
    ...
    main: function (bot, msg) {
        var numGiven = 0;
        var allowedRoles = ['Light Blue', 'Dark Blue', 'Orange', 'Yellow', 'Blurple', 'Purple', 'Green', 'Peach', 'Pink', 'Red', 'VC', 'teen that cares™', 'Movie-goers', 'academia', 'aesthetic', 'coders', 'floofs', 'News'];
