module.exports = {
    ...
    main: function(bot, msg) {
        ...
        var arr1 = [`Ahem, ` + sleepee + `, shouldn't you be asleep?`,
                    `Go to sleep, ` + sleepee + `!`, `By the power vested in me, I banish thee to bed, ` + sleepee + `!`,
                    `Hey, psst, ` + sleepee + `, you should sleep.`, `My guy, please go to bed, ` + sleepee + `.`,
                    `If you don't go to bed now, you'll hate yourself in the morning. Trust me, I've been there. Go to sleep now, and reap the benefits tomorrow, ` + sleepee + `.`,
                    `Your friend wants you to get a good night's rest, and I'm obligated by the voice of reason within us all to back them up on that request. Go to sleep, ` + sleepee + `.`]
